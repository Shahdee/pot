...
public class LevelLogic: IUpdatable
{
    ...
    UnityAction<int> m_OnLevelEndCallback;
...
#region Callbacks
    ...
    //level end 
    public void AddLevelEndListener(UnityAction<int> listener){
        m_OnLevelEndCallback += listener;
    }

    public void RemoveLevelEndListener(UnityAction<int> listener){
        m_OnLevelEndCallback -= listener;
    }

    public void OnLevelEnd(int level){
        if (m_OnLevelEndCallback != null)
            m_OnLevelEndCallback(level);
    }
